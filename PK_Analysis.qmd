...
# Load the model
mouse_model <- mread("model/Bigelow_bicomp_oral")
...
ggsave(file.path(getwd(), "results/mouse", "Bigelow - PK Analysis.png"), dpi = "retina")
...
mouse_model <- mread("model/andes/Monocomp_IV_NonLinear_CL")
...
ggplot() +
    ...
    labs(title = "Andes PK study - Monocomp Non Linear CL - Plasma concentrations",
         x = "Time (h)",
         y = "Concentration (mg/L)",
         color = "Doses") +
    theme_classic()

ggsave(file.path(getwd(), "results/mouse", "Andes - PK Analysis - Monocomp non linear CL.png"), dpi = "retina")
...
# If we want to check another model, just change the model name in mread
mouse_model <- mread("model/sandberg/Monocomp_IV_Linear_CL")
...
ggsave(file.path(getwd(), "results/mouse", "Sandberg - PK Analysis - Monocomp non linear CL.png"), dpi = "retina")
