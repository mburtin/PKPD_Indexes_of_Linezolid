...
Generate a table with different PD targets (bacteriostasis, 1-log kill, 2-log kill) for each PKPD index with index values. It will also generate a resume of index values for different PD targets.
...
We can use various analyses to resume our data. In this block, we can find a resume of PKPD data with different stratification.
...
Another check about the mean & median of PD Endpoints across AMT for each dosing regimens (DoseGroup). It allow to visualize the difference observe in targets_summary dataset with plasma_by_AMT_and_DG & csf_by_AMT_and_DG
...
csf_vpc_data <- list(
  ...
  sim_data = generate_pred_data(csf_data[["correlation_data"]], generate_obs_data(csf_data[["sim_data"]]), 10)
)
...
```{r}
data_obs <- csf_vpc_data$obs_data |> filter(PKPD_Index == "I2_AUC")
data_sim <- csf_vpc_data$sim_data |> filter(PKPD_Index == "I2_AUC")
...
ggplot() +
      geom_smooth(data = auc_obs, aes(x = x_mean, y = p5), 
                  method = "gam", color = "black", linetype = "dashed", size = 0.5, se = FALSE, span = 1) +
      geom_smooth(data = auc_obs, aes(x = x_mean, y = p50), 
                  method = "gam", color = "black", linetype = "solid", size = 0.75, se = FALSE, span = 1) +
      geom_smooth(data = auc_obs, aes(x = x_mean, y = p95), 
                  method = "gam", color = "black", linetype = "dashed", size = 0.5, se = FALSE, span = 1) +
      geom_smooth(data = auc_sim, aes(x = x_mean, y = p5), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = auc_sim, aes(x = x_mean, y = p50), 
                  method = "gam", color = "red", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = auc_sim, aes(x = x_mean, y = p95), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      scale_x_continuous(
        limits = c(1, 1000),
...
```{r}
data_obs <- csf_vpc_data$obs_data |> filter(PKPD_Index == "I1_Cmax")
data_sim <- csf_vpc_data$sim_data |> filter(PKPD_Index == "I1_Cmax")
...
ggplot() +
      ...
      geom_smooth(data = cmax_obs, aes(x = x_mean, y = p95), 
                  method = "gam", color = "black", linetype = "dashed", size = 0.5, se = FALSE, span = 1) +
      geom_smooth(data = cmax_sim, aes(x = x_mean, y = p5), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = cmax_sim, aes(x = x_mean, y = p50), 
                  method = "gam", color = "red", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = cmax_sim, aes(x = x_mean, y = p95), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      scale_x_continuous(
        limits = c(0.1, 100),
...
And finally, T\>MIC VPCs in CSF

```{r}
data_obs <- csf_vpc_data$obs_data |> filter(PKPD_Index == "I3_ToverMIC")
data_sim <- csf_vpc_data$sim_data |> filter(PKPD_Index == "I3_ToverMIC")
...
ggplot() +
      ...
      geom_smooth(data = tmic_obs, aes(x = x_mean, y = p95), 
                  method = "gam", color = "black", linetype = "dashed", size = 0.5, se = FALSE, span = 1) +
      geom_smooth(data = tmic_sim, aes(x = x_mean, y = p5), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = tmic_sim, aes(x = x_mean, y = p50), 
                  method = "gam", color = "red", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      geom_smooth(data = tmic_sim, aes(x = x_mean, y = p95), 
                  method = "gam", color = "blue", linetype = "solid", size = 0.6, se = FALSE, span = 1) +
      scale_x_continuous(
        limits = c(0, 100),
