...
```{r}
source("RScripts/vpc_script_new.R")

## Generate VPC binned data
binned_data_new <- list(
  cmax_obs = csf_vpc_obs_data$cmax,
  auc_obs = csf_vpc_obs_data$auc,
  tmic_obs = csf_vpc_obs_data$tmic,
  
  cmax_sim = csf_vpc_pred_data$cmax,
  auc_sim = csf_vpc_pred_data$auc,
  tmic_sim = csf_vpc_pred_data$tmic
)
```
...
## Generate VPC plots
#VPC_Plots(binned_data, "VPC - CSF with plasma indices.png", csf_with_plasma_index_data)
VPC_Plots(binned_data, "VPC - CSF.png", csf_data)
```
