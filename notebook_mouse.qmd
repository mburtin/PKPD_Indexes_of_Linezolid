...
model_list <- list(
    # S. Aureus
    SA6538p = param(model_file, B0 = 6.29, Bmax = 9.26, Kg = 1.09,
                    Emax = 1.93, EC50 = 1.1, Kon = 0.016, MIC = 2.0)
)

# Specify AMT choosen for fractioned doses
fractioned_daily_AMT <- c(0, 2.5, 3, 5, 8, 10, 25, 40, 80, 120, 160, 640, 900, 1280)
...
pkpd_plot <- PKPD_index_plots(obs_data = data[["sim_data"]], 
                             ...
                             title = "Reproduction of Andes PKPD Index for Linezolid - Non Linear PK" ,
                             file_name = "Andes PKPD Index for Linezolid - Non Linear PK.png")
```
